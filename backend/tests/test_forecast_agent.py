...
def test_clear_noon_generates_power():
    point = agent.predict_point(
        site=SITE,
        ghi_w_m2=900.0, dni_w_m2=750.0, dhi_w_m2=120.0,
        temperature_c=30.0, cloud_cover_percent=5.0,
        timestamp=datetime(2026, 6, 25, 6, 30, tzinfo=timezone.utc),  # ~noon IST
        wind_speed_mps=2.0,
    )
...
def test_night_generates_zero():
    point = agent.predict_point(
        site=SITE,
        ghi_w_m2=0.0, dni_w_m2=0.0, dhi_w_m2=0.0,
        temperature_c=22.0, cloud_cover_percent=0.0,
        timestamp=datetime(2026, 6, 25, 20, 0, tzinfo=timezone.utc),
    )
...
def test_prediction_never_exceeds_capacity():
    point = agent.predict_point(
        site=SITE,
        ghi_w_m2=1400.0, dni_w_m2=1000.0, dhi_w_m2=200.0,
        temperature_c=25.0, cloud_cover_percent=0.0,
...
def test_cloud_lowers_confidence():
    clear = agent.predict_point(
        site=SITE, ghi_w_m2=800, dni_w_m2=700, dhi_w_m2=100,
        temperature_c=30, cloud_cover_percent=10,
        timestamp=datetime(2026, 6, 25, 6, 30, tzinfo=timezone.utc),
    )
    cloudy = agent.predict_point(
        site=SITE, ghi_w_m2=400, dni_w_m2=200, dhi_w_m2=200,
        temperature_c=30, cloud_cover_percent=90,
        timestamp=datetime(2026, 6, 25, 6, 30, tzinfo=timezone.utc),
    )
