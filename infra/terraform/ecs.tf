...
# Uncomment when you have an ACM certificate for HTTPS
...
# IAM — Task role (for the app itself; add permissions here as needed)
...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "WEATHER_PROVIDER", value = "open-meteo" },
      { name = "WEATHER_API_BASE_URL", value = "https://api.open-meteo.com/v1/forecast" },
      { name = "DSM_DEFAULT_REGION", value = "Karnataka" },
      { name = "DSM_DEFAULT_RULE_PROFILE", value = "kerc-solar" },
